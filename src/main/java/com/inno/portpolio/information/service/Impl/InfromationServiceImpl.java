...
import com.inno.portpolio.information.vo.InformationVO;
...
public class InfromationServiceImpl implements InformationService {
	...
	@Override
	public List<SchoolVO> retrieveSchoolInformation() {
		
		List<SchoolVO> schoolInfo = informationMapper.selectSchoolInformation();
	...
	@Override
	public List<CertificateVO> retrieveCertificateInformation() {
		
		List<CertificateVO> certificateInfo = informationMapper.selectCertificateInformation();
	...
	@Override
	public ServiceResult modifyProfileInformation(UsersVO uesr) {
		int cnt=0;
		ServiceResult res;
	...
	@Override
	public ServiceResult removeSchool(SchoolVO school) {
		int cnt=0;
		ServiceResult res;
	...
	@Override
	public ServiceResult removeCertificate(CertificateVO certificate) {
		int cnt=0;
		ServiceResult res;
